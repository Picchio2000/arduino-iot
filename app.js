...
const API_BASE_URL = 'http://217.154.163.109:3000/api';
...
let fcmToken = null;
let currentChartMonth = new Date().getMonth(); // 0-11
...
async function loadStats() {
    try {
        const response = await fetch('http://217.154.163.109:3000/api/utilizzo/stats');
...
async function updateCharts() {
    try {
        ...
        // Daily chart
        const todayResponse = await fetch('http://217.154.163.109:3000/api/utilizzo/today');
        ...
        const monthResponse = await fetch(`http://217.154.163.109:3000/api/utilizzo/month?year=${year}&month=${month}`);
